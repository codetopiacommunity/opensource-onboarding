...
[Merge](#merge) · [Merge conflict](#merge-conflict) ·
[Open source](#open-source) · [origin](#origin) · [Path](#path) ·
...
Spelled **license** in American English, and in the filename.
...
Almost always shortened to **repo**, said "REP-oh".
