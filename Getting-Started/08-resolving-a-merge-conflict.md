...
[← Finding and Claiming an Issue](./07-finding-and-claiming-an-issue.md) · **Resolving a Merge Conflict** · [Keeping Your Fork in Sync →](./09-keeping-your-fork-in-sync.md)
